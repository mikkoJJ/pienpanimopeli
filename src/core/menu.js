(function () {
    ...
    Brew.Menu.prototype = {
        ...
        create: function () {
            ...
            this.add.tween(this.credits).to({ x: -2000 }, 20000, Phaser.Easing.Linear.None, true, 0, -1);
        },
        
        play: function() {
            this.sfx.play('kilahdus');
            
            this.add.tween(this.playbutton).to({ y: this.camera.height + 50 }, 800, Phaser.Easing.Back.In, true)
                .onComplete.add(function() { this.state.start('Main'); }, this);
        },
